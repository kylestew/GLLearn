...
void *read_tga(const char *filename, int *width, int *height)
{
    ...
    // wow!
//    CFURLRef urlRef = CFBundleCopyResourceURL(CFBundleGetMainBundle(), CFSTR("hello1"), CFSTR("tga"), NULL);
//    CFStringRef imagePath = CFURLCopyFileSystemPath(urlRef, kCFURLPOSIXPathStyle);
